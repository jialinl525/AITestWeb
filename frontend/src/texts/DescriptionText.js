export const DescriptionText = {
  ...
  bugs: {
    ...
    placeholders: {
      ...
      selectFromAvailableImages: 'Select from available images'
    },
    toast: {
      ...
      noAvailableImage: 'No available image found for quick selection',
      selectImageRequired: 'Please select an image',
      quickBuildUpdated: 'Software Image Integration Build updated',
      movedToVerified: 'Moved to Verified',
      selectBugsToVerify: 'Please select bugs to verify',
      selectBugsToDelete: 'Please select bugs to delete',
      bulkVerifyConfirmPrefix: 'Move',
      bulkVerifyConfirmSuffix: 'selected bugs to Verified?',
      bulkVerifyConfirmTitle: 'Confirm Bulk Verify',
      bulkVerifySuccessPrefix: 'Moved',
      bulkVerifySuccessSuffix: 'bugs to Verified',
      bulkVerifyFailedPrefix: 'Failed to move',
      bulkVerifyFailedSuffix: 'bugs to Verified',
      bulkDeleteConfirmPrefix: 'Delete',
      bulkDeleteConfirmSuffix: 'selected bugs?',
      bulkDeleteConfirmTitle: 'Confirm Bulk Delete',
      bulkDeleteSuccessPrefix: 'Deleted',
      bulkDeleteSuccessSuffix: 'bugs',
      bulkDeleteFailedPrefix: 'Failed to delete',
      bulkDeleteFailedSuffix: 'bugs',
